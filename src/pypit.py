...
def Main(argflag, quick=False):
    ...
    """
        ...
        transpose = False   # Determine if the frames need to be transposed
        ...
        # Load the Input file
        parlines, datlines, spclines = arload.load_input(self)
