...
class FlatField(processimages.ProcessImages, masterframe.MasterFrame):
    ...
    def run(self, datasec_img, lordloc, rordloc, pixwid, slitpix, tilts, settings_det, trim=True, armed=False):
        ...
        slit_profiles, mstracenrm, msblaze, flat_ext1d, extrap_slit = \
            arproc.slit_profile(self.mspixelflat, datasec_img, lordloc, rordloc, pixwid, slitpix,
