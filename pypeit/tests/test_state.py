...
def test_flats_slit_model_and_skip_status():
    ...
    into ``slit_classes``.  Generated by JXP and Claude.
    """
...
def test_safe_update_science_sets_step_and_fields():
    ...
    returns False (no raise) on a bad field.  Generated by JXP and Claude.
    """
    s = state.RunPypeItState(pypeit_file='x.pypeit', current_step='init',
                             current_det=-1, current_calibID=-1)
...
def test_science_full_roundtrip(tmp_path):
    ...
    survives a write/load round trip.  Generated by JXP and Claude.
    """
    s = make_state(tmp_path)
...
def test_get_science_status_table():
    ...
    macro-step columns; None when empty.  Generated by JXP and Claude.
    """
    s = state.RunPypeItState(pypeit_file='x.pypeit', current_step='init',
                             current_det=-1, current_calibID=-1)
...
def test_science_status_safe_float():
    ...
    uncastable input, never raising.  Generated by JXP and Claude.
    """
...
def test_science_status_det_from_name():
    ...
    for mosaics / unparseable names.  Generated by JXP and Claude.
    """
...
def test_science_status_basename_from_product():
    ...
    ``<prefix>_<basename>.fits`` and returns None on a mismatch.  Generated
    by JXP and Claude.
    """
...
def test_derive_science_from_disk_empty_dir_is_noop(tmp_path):
    ...
    and returns it (the graceful no-product path).  Generated by JXP and
    Claude.
    """
    s = make_state(tmp_path)
