...
def test_profile_spec():
    ...
    for f in files:
        ...
        spec_bspl, spec_gpm_fit, spec_flat_fit, _, exit_status \
                = bspline.bspline_profile(d['spec_coo_data'], d['spec_flat_data'], d['spec_ivar_data'],
...
def test_profile_spat():
    ...
    for f in files:
        ...
        spat_bspl, spat_gpm_fit, spat_flat_fit, _, exit_status \
                = bspline.bspline_profile(d['spat_coo_data'], d['spat_flat_data'],
...
def test_profile_twod():
    ...
    for f in files:
        ...
        twod_bspl, twod_gpm_fit, twod_flat_fit, _ , exit_status \
                = bspline.bspline_profile(d['twod_spec_coo_data'], d['twod_flat_data'],
