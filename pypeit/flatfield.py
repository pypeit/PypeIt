...
def illum_profile_spectral_poly(rawimg, waveimg, slits, model, slit_illum_ref_idx=0,
                                gpmask=None, thismask=None, trim=3, flexure=None, nbins=20):
    """
    ...
    gpmask : `numpy.ndarray`_, None
        Good pixel mask
    thismask : `numpy.ndarray`_, None
        A mask (True = good) that indicates all pixels where the scaleImg should be constructed. If None,
        the slitmask that is generated by this routine will be used.
    trim : int
        Number of pixels to trim from the edges of the slit
        when deriving the spectral illumination
    flexure : float, None
