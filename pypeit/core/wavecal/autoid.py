...
# TODO: All of this should be in the descriptions of the
# WavelengthSolutionPar parameter set.

#   sigdetect: float, default 5.0
#       For arc line detection: Sigma threshold above fluctuations
#       for arc-line detection. Arcs are continuum subtracted and the
