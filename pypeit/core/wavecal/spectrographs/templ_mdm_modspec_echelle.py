...
def mdm_modspec_echelle(overwrite=True):
    ...
    binspec = 1
    outroot = 'mdm_modspec_echelle_NeXeAr.fits'
    ...
    # Snippets
    slits = [150] ## I THINK they want the spatial id --> NO they want "slits in the archive files to use" ... but we have no archived files. the wfiles?? --> try it
    wv_cuts = []
