...
Vendored from https://github.com/t-brandt/fitramp
(MIT License, Copyright (c) 2023-2024 Timothy D. Brandt).

The algorithm is described in Brandt (2024a), PASP 136, 045005
(https://arxiv.org/abs/2404.01326) and Brandt (2024b)
(https://arxiv.org/abs/2309.08753).

.. warning::
    This module is intentionally kept byte-close to the upstream
    implementation so that upstream fixes can be diffed in.  Do not refactor
    it to PypeIt conventions.
"""
import numpy as np
