...
def init_qso_pca(filename,wave_grid,redshift, npca):
    """
...
def qso_pca_eval(theta,qso_pca_dict):
    ...
    Args:
        ...
        qso_pca_dict (dict):
          Dictionary continaing the PCA information generated by init_qso_pca
...
def sensfunc_telluric(wave, counts, counts_ivar, counts_mask, exptime, airmass, std_dict,
                      telgridfile, ech_orders=None, polyorder=8, ntell=6, mask_hydrogen_lines=True,
