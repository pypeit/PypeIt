...
def spline_map(rawimg, rawivar, waveimg, slitmask, slitmask_trim, modelimg,
    ...
    scale_model: `numpy.ndarray`_
        An image containing the appropriate scaling
    """
    # TODO :: REMOVE THIS... IT IS USED AS A GUIDE TO DEVELOP THE METHOD!!!
    ...
    # resid = w*(y-f(x))
    # Then, iterate over this. The reason to iterate is that there should be a mapping between science and science_error. Once we have an estimate of f(x), we can do the following:
