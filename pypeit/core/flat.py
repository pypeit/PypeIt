...
# TODO: This is deprecated, and replaced by tweak_slit_edges above.
# Keep this around though because we need to make sure there are no
# unforeseen corner cases that cause errors in the new code.
#
