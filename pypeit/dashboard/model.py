...
SCIENCE_COLUMNS = ['frame', 'detector', 'objtype', 'process', 'findobj',
...
class DashboardModel:
    ...
    def science_table(self):
        ...
        Returns:
            `pandas.DataFrame`_: Columns :data:`SCIENCE_COLUMNS`; empty when
            there are no science entries.
        """
        if self.run_state is None:
            return pd.DataFrame(columns=SCIENCE_COLUMNS)
    ...
    def has_science(self):
        ...
        """
        return not self.science_table().empty
    ...
    def science_qa_files(self, frame, det):
        ...
        Returns:
            list: Sorted `pathlib.Path`_ of the matching QA PNGs (empty if the
