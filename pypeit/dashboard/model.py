...
class DashboardModel:
    ...
    def __init__(self, pypeit_file, redux_path=None, derive=True):
        ...
        # Header metadata (cheap; also tells us the pipeline).  A missing
        # .pypeit file is an edge state, not a crash (R11).
        try:
            self.header_info = read_header_info(self.pypeit_file,
