...
class TraceSlits(masterframe.MasterFrame):
    ...
    def __init__(self, mstrace, spectrograph, binning=None,
    ...
    def from_master_files(cls, root, load_pix_obj=False, par=None):
        ...
        slf = cls(fits_dict['MSTRACE'], spectrograph, msbpm=msbpm, par=par)
    ...
    def add_user_slits(self, user_slits, orig=False):
        """
        ...
        Args:
            user_slits (list):
            orig (bool, optional): Use the original method (to be Deprecated)
