...
class QLViewUI:
    ...
    def build(self, container) -> None:
        ...
        hbox_cadence = Widgets.HBox()
        hbox_cadence.add_widget(Widgets.Label("Poll cadence (s):"), stretch=0)
        ...
        hbox_cadence.add_widget(self.plugin.cadence_entry, stretch=0)
        self.plugin.vbox_redux.add_widget(hbox_cadence, stretch=0)
