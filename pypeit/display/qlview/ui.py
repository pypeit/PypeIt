...
class QLViewUI:
    ...
    def build(self, container) -> None:
        ...
        hbox_raw_filter = Widgets.HBox()
        self.plugin.raw_show_fits = Widgets.CheckBox("FITS Files")
        self.plugin.raw_show_fits.set_state(True)
        self.plugin.raw_show_fits.add_callback("activated", self.plugin.raw_filter_cb)
        self.plugin.raw_show_nonfits = Widgets.CheckBox("Non-FITS Files")
        self.plugin.raw_show_nonfits.set_state(False)
        self.plugin.raw_show_nonfits.add_callback("activated", self.plugin.raw_filter_cb)
        self.plugin.raw_show_dirs = Widgets.CheckBox("Directories")
        self.plugin.raw_show_dirs.set_state(True)
        self.plugin.raw_show_dirs.add_callback("activated", self.plugin.raw_filter_cb)
        hbox_raw_filter.add_widget(self.plugin.raw_show_fits, stretch=0)
        hbox_raw_filter.add_widget(self.plugin.raw_show_nonfits, stretch=0)
        hbox_raw_filter.add_widget(self.plugin.raw_show_dirs, stretch=0)
        fr_vbox.add_widget(hbox_raw_filter, stretch=0)
        ...
        hbox_reduced_filter = Widgets.HBox()
        self.plugin.reduced_show_fits = Widgets.CheckBox("FITS Files")
        self.plugin.reduced_show_fits.set_state(False)
        self.plugin.reduced_show_fits.add_callback("activated", self.plugin.reduced_filter_cb)
        self.plugin.reduced_show_nonfits = Widgets.CheckBox("Non-FITS Files")
        self.plugin.reduced_show_nonfits.set_state(False)
        self.plugin.reduced_show_nonfits.add_callback("activated", self.plugin.reduced_filter_cb)
        self.plugin.reduced_show_dirs = Widgets.CheckBox("Directories")
        self.plugin.reduced_show_dirs.set_state(True)
        self.plugin.reduced_show_dirs.add_callback("activated", self.plugin.reduced_filter_cb)
        hbox_reduced_filter.add_widget(self.plugin.reduced_show_fits, stretch=0)
        hbox_reduced_filter.add_widget(self.plugin.reduced_show_nonfits, stretch=0)
        hbox_reduced_filter.add_widget(self.plugin.reduced_show_dirs, stretch=0)
        fr_vbox.add_widget(hbox_reduced_filter, stretch=0)
        ...
        hbox = Widgets.HBox()
        self.plugin.redux_path_entry = Widgets.TextEntry()
        self.plugin.redux_path_entry.set_text(self.plugin.state.redux_path)
        self.plugin.redux_path_entry.set_tooltip("Path to the reduction directory")
        hbox.add_widget(Widgets.Label("Reduction Path:"), stretch=0)
        hbox.add_widget(self.plugin.redux_path_entry, stretch=1)
        ...
        hbox_show = Widgets.HBox()
        self.plugin.btn_show = Widgets.Button("Show")
        self.plugin.btn_show.set_tooltip("Show the reduced spec1d file")
        self.plugin.btn_show.set_enabled(False)
        self.plugin.btn_show.add_callback("activated", self.plugin.show_spec1d_cb)
        hbox_show.add_widget(self.plugin.btn_show, stretch=0)

        hbox_show.add_widget(Widgets.Label("Poll cadence (s):"), stretch=0)
        self.plugin.cadence_entry = Widgets.TextEntry()
        self.plugin.cadence_entry.set_text(str(self.plugin.reduction_cadence))
        self.plugin.cadence_entry.set_tooltip("How often (seconds) to check for reduction output")
        self.plugin.cadence_entry.add_callback("activated", self.plugin.cadence_entry_cb)
        hbox_show.add_widget(self.plugin.cadence_entry, stretch=0)
        self.plugin.vbox_redux.add_widget(hbox_show, stretch=0)
        ...
        btns.add_widget(btn, stretch=0)
        btn = Widgets.Button("Backend")
        btn.set_tooltip("Configure local or remote backend")
        btn.add_callback("activated", lambda w: self.plugin.open_backend_dialog())
        btns.add_widget(btn, stretch=0)
