...
class KeckKCWIKCRMSpectrograph(spectrograph.Spectrograph):
    ...
    def default_pypeit_par(cls):
        ...
        par['scienceframe']['process']['spat_flexure_correct'] = "detector"  # don't correct for spatial flexure - varying spatial illumination profile could throw this correction off. Also, there's no way to do astrometric correction if we can't correct for spatial flexure of the contbars frames
