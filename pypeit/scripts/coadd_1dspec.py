    ...
    def get_parser(cls, width=None):
        ...
        parser.add_argument('coadd1d_file', type=str,
                            help="R|File to guide coadding process.\n\n"
                                 ...
                                 "\n"
                                 "F|   coadd1d read\n"
                                 "F|        filename | obj_id | sensfuncfile  | setup_id \n"
                                 "F|     spec1dfile1 | objid1 | sensfuncfile1 | setup_id1\n"
                                 "F|     spec1dfile2 | objid2 | sensfuncfile2 | setup_id2\n"
                                 "F|     spec1dfile3 | objid3 | sensfuncfile3 | setup_id3\n"
                                 "F|        ...    \n"
                                 "F|   coadd1d end\n"
                                 "\n OR the coadd1d read/end block can look like \n\n"
                                 "F|  coadd1d read\n"
                                 "F|        filename | obj_id | sensfuncfile | setup_id |\n"
                                 "F|     spec1dfile1 | objid1 | sensfuncfile | setup_id\n"
                                 "F|     spec1dfile2 |        |              |         \n"
                                 "F|     spec1dfile3 |        |              |         \n"
                                 "F|        ...    \n"
                                 "F|   coadd1d end\n"
