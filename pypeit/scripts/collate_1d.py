...
def find_archvie_files_from_spec1d(par, spec1d_files):
    ...
    Returns:
        tuple: Returns three lists, **spec1d_text_files**, **pypeit_files**, **missing_archive_msgs**
               ...
               missing_archive_msgs (list of str): A list of messages for the "collate_warnings.txt" file
                                                   about missing files needed for archiving.
    """
