...
=============  ==============================================  =======================================================================================================  ============================  ===============================================================================================================================================================================================================================================================
<<<<<<< HEAD
``frametype``  str                                             ``bias``, ``pinhole``, ``standard``, ``dark``, ``pixelflat``, ``science``, ``tilt``, ``arc``, ``trace``  ``science``                   Frame type.  Options are: bias, pinhole, standard, dark, pixelflat, science, tilt, arc, trace                                                                                                                                                                  
=======
``frametype``  str                                             ``bias``, ``dark``, ``standard``, ``pixelflat``, ``tilt``, ``science``, ``arc``, ``trace``, ``pinhole``  ``science``                   Frame type.  Options are: bias, dark, standard, pixelflat, tilt, science, arc, trace, pinhole                                                                                                                                                                  
>>>>>>> develop
