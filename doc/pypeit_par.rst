...
``outdir``                 str         ..       ``/Users/tim/MMT/pypeit/doc``  The path where all coadded output files and report files will be placed.                                                                                                                                                                                                                                                                                                                                      
...
``redux_path``          str             ..       ``/Users/tim/MMT/pypeit/doc``  Path to folder for performing reductions.  Default is the current working directory.                                                                                                                                                                                                                                                                            
