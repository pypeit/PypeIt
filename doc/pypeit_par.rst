...
``outdir``                 str         ..       ``/Users/westfall/Work/packages/pypeit/doc/scripts``  The path where all coadded output files and report files will be placed.                                                                                                                                                                                                                                                                                                                                      
...
``redux_path``          str             ..       ``/Users/westfall/Work/packages/pypeit/doc/scripts``  Path to folder for performing reductions.  Default is the current working directory.                                                                                                                                                                                          
