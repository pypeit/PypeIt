...
``smash_range``       list        ..                                           0.0, 1.0      Range of the slit (in fractional units) to smash when searching for slit edges. If the spectrum covers only a portion of the image, use that range.                                                                                                                                                                                                                                                                                         
