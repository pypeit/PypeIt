...
``outdir``                 str         ..       ``/Users/westfall/Work/packages/pypeit-test/doc``  The path where all coadded output files and report files will be placed.                                                                                                                                                                                                                                                                                                                                      
...
``redux_path``          str             ..       ``/Users/westfall/Work/packages/pypeit-test/doc``  Path to folder for performing reductions.  Default is the current working directory.                                                                                                                                                                                                                                                                            
...
``master_setup_and_bit``  str         ..                                      ..          Over-ride the master setup and bit, e.g. "A_7".  Only recommended for use with quicklook                                                                                                                                                                                                                                                                    
