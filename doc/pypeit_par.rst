...
.. _instr_par-ldt_rimas_grism:

LDT RIMAS (``ldt_rimas_grism``)
-------------------------------
Alterations to the default parameters are:
...
.. _instr_par-ldt_rimas_hk_grism:

LDT RIMAS_HK (``ldt_rimas_hk_grism``)
-------------------------------------
Alterations to the default parameters are:
...
.. code-block:: ini
  ...
  [rdx]
      spectrograph = ldt_rimas_hk_grism
  [calibrations]
      bpm_usebias = True
      [[biasframe]]
          [[[process]]]
...
.. _instr_par-ldt_rimas_hk_vph:

LDT RIMAS_HK (``ldt_rimas_hk_vph``)
-----------------------------------
Alterations to the default parameters are:
...
.. _instr_par-ldt_rimas_vph:

LDT RIMAS (``ldt_rimas_vph``)
-----------------------------
Alterations to the default parameters are:
...
.. _instr_par-ldt_rimas_yj_grism:

LDT RIMAS_YJ (``ldt_rimas_yj_grism``)
-------------------------------------
Alterations to the default parameters are:
...
.. code-block:: ini
  ...
  [rdx]
      spectrograph = ldt_rimas_yj_grism
  [calibrations]
      bpm_usebias = True
      [[biasframe]]
          [[[process]]]
...
.. _instr_par-ldt_rimas_yj_vph:

LDT RIMAS_YJ (``ldt_rimas_yj_vph``)
-----------------------------------
Alterations to the default parameters are:
