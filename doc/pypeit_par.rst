...
Key                  Type        Options                            Default               Description                                                                                                                                                                                                                                                                                               
===================  ==========  =================================  ====================  ==========================================================================================================================================================================================================================================================================================================
``excessive_shift``  str         ``crash``, ``skip``, ``continue``  ``crash``             Behavior when the measured spectral flexure shift is larger than ``spec_maxshift``.  The options are: 'crash' - Raise an error and halt the data reduction; 'skip' - Set the flexure shift to zero and continue with the reduction; and 'continue' - Use the large flexure value whilst issuing a warning.
