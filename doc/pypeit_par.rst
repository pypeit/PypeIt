...
Key            Type                                            Options                                                                                                  Default                       Description                                                                                                                                                                                                                                                    
=============  ==============================================  =======================================================================================================  ============================  ===============================================================================================================================================================================================================================================================
``frametype``  str                                             ``trace``, ``bias``, ``science``, ``standard``, ``pixelflat``, ``dark``, ``tilt``, ``arc``, ``pinhole``  ``science``                   Frame type.  Options are: trace, bias, science, standard, pixelflat, dark, tilt, arc, pinhole                                                                                                                                                                  
...
``algorithm``       str                                            ..       ``UVIS``                     Specify the algorithm for computing the sensitivity function. The options are:
