...
spectra and the subsequent extraction of the 1D spectra. See :ref:`coadd2d_file`.
Unlike the :ref:`pypeit_file`, the coadd2d file needs to be generated by the user and needs
to be divided into two blocks: a `Parameter Block`_ and a `Data Block`_.
Here is an example of a coadd2d file::
    ...
    [coadd2d]
       ...
       weights = uniform
       manual = 1:22.4:608.1:3.;1:40.2:608.1:3.       # det:spat:spec:fwhm
...
In this case, you will notice that there are no ``[coadd2d]`` parameters here. This means that the default
