...
You will need to place their .dat file (make sure the flux column is in flux units rather than magnitudes, i.e. those files starting with `f`)
 in pypeit/data/standards/esofil/ and then edit the *esofil_info.txt* file accordingly. 
