...
.. THIS LINK IS OUT OF DATE. WHAT SHOULD IT BE?  THE Telluric DIRECTORY IN THE
.. SHARED GOOGLE FOLDER PypeIt-development-suite?

 - Make sure you have downloaded the relevant atmosphere telluric models.  See
   :doc:`installing`.  If you do not find a specified model for your
   observatory, you can use the Maunakea model as an approximation. It includes
   a large grid of different parameters and should be good enough for most
   purposes.

.. HOW DOES SOMEONE DO THIS IF THEY HAVE USED PIP TO INSTALL PYPEIT? 

 - Put the telluric models into the directory:
   your_path/Pypeit/pypeit/data/telluric
