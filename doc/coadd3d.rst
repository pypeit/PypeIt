...
.. code-block:: console
    ...
    pypeit_setup_datacube kcrm_jun10_hizqso.pypeit J0750+6927 \
        /Users/joe/kcrm_observing_2024/dec2024/hiz_qso_dec2024/sens_gd71_000.fits
...
the first.  The ``--overwrite`` option is needed if the ``.extract`` file already exists and
you want the script to replace it.  The generated ``.extract`` file will include:
