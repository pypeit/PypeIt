...
the ``coadd2d`` file (see :ref:`coadd2d_file`).  Unlike the :ref:`pypeit_file`,
the coadd2d file needs to be generated by the user.  The format of this type of
:doc:`../input_files` includes a `Parameter Block`_ (optional) and a `Data
Block`_ (required).
