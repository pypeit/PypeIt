...
1. Make sure you have up to date versions of the `PypeIt <https://github.com/pypeit/PypeIt>`_ and `PypeIt Development Suite`_ 
   repositories from GitHub, and that PypeIt :doc:`../installing` is complete.
