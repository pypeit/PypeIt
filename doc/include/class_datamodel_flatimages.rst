...
``illumflat_spat_bsplines``  `numpy.ndarray`_  :class:`~pypeit.core.bspline.bspline.bspline`  B-spline models for illum flat; see :class:`~pypeit.core.bspline.bspline.bspline`   
...
``pixelflat_spat_bsplines``  `numpy.ndarray`_  :class:`~pypeit.core.bspline.bspline.bspline`  B-spline models for pixel flat; see :class:`~pypeit.core.bspline.bspline.bspline`   
