...
``illumflat_spat_bsplines``  `numpy.ndarray`_  :class:`~pypeit.containers.bspline.BSplineContainer`  B-spline models for illum flat; see :class:`~pypeit.core.bspline.containers.BSplineContainer`
...
``pixelflat_spat_bsplines``  `numpy.ndarray`_  :class:`~pypeit.containers.bspline.BSplineContainer`  B-spline models for pixel flat; see :class:`~pypeit.core.bspline.containers.BSplineContainer`
