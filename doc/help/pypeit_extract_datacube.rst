.. code-block:: console
    ...
    [1;34musage: [0m[1;35mpypeit_extract_datacube[0m [[32m-h[0m] [[32m-v [33mVERBOSITY[0m] [[36m--log_file [33mLOG_FILE[0m]
                                   [[36m--log_level [33mLOG_LEVEL[0m] [[32m-e [33mEXT_FILE[0m] [[32m-s [33mSAVE[0m]
                                   [[32m-o[0m] [[32m-b [33mBOXCAR_RADIUS[0m]
                                   [32mfile[0m
    ...
    [1;34mpositional arguments:[0m
      [1;32mfile[0m                  spec3d.fits DataCube file
    ...
    [1;34moptions:[0m
      ...
      [1;32m-e[0m, [1;36m--ext_file[0m [1;33mEXT_FILE[0m
                            Configuration file with extraction parameters (default:
                            None)
      [1;32m-s[0m, [1;36m--save[0m [1;33mSAVE[0m       Output spec1d filename (default: None)
      [1;32m-o[0m, [1;36m--overwrite[0m       Overwrite any existing files/directories (default:
                            False)
      [1;32m-b[0m, [1;36m--boxcar_radius[0m [1;33mBOXCAR_RADIUS[0m
