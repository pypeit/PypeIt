.. code-block:: console
    ...
    [1;34musage: [0m[1;35mpypeit_chk_wavecalib[0m [[32m-h[0m] [[32m-v [33mVERBOSITY[0m] [[36m--log_file [33mLOG_FILE[0m]
                                [[36m--log_level [33mLOG_LEVEL[0m] [[36m--try_old[0m]
                                [32minput_file [input_file ...][0m
    
    Print QA on Wavelength Calib to the screen
    
    [1;34mpositional arguments:[0m
      [1;32minput_file[0m            One or more PypeIt WaveCalib file [e.g.
